    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prefecture', models.CharField(blank=True, max_length=20, null=True, verbose_name='都道府県')),
                ('city', models.CharField(blank=True, max_length=50, null=True, verbose_name='市区町村')),
                ('street_address_1', models.CharField(blank=True, max_length=100, null=True, verbose_name='町名・番地')),
                ('street_address_2', models.CharField(blank=True, max_length=100, null=True, verbose_name='建物名・部屋番号')),
                ('building_name', models.CharField(blank=True, max_length=100, null=True, verbose_name='建物名')),
